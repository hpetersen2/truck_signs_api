...
Create a `.env` file in the project root. **Never commit this file to version control** — it is listed in `.gitignore`.

```dotenv
# Django
SECRET_KEY=<your-django-secret-key>

# Database — must match the values used for the PostgreSQL container
...
DOCKER_DB_NAME=<db-name>
DOCKER_DB_USER=<db-user>
...
CORS_ALLOWED_ORIGINS=http://localhost:8020
...
To generate a new Django secret key, see: [Stackoverflow — Django secret key generation](https://stackoverflow.com/questions/41298963/is-there-a-function-for-generating-settings-secret-key-in-django)
